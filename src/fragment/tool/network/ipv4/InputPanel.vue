...
<template>
	<div>
		<div class="mb-2 flex items-center justify-between">
			<label class="text-xs font-semibold text-slate-500">IPv4 地址 / CIDR</label>
		...
		<div class="relative">
			...
			>
				<div class="mb-2 text-slate-300">
					<TkuIcon :name="icons.ipv4" :size="28" />
				</div>
				<p class="text-slate-400 text-xs">输入 IPv4 地址，解析结果将自动更新</p>
			</div>
		</div>
	</div>
</template>
