...
<template>
	<!-- InputPanel：JavaScript 源代码输入区 -->
	<div class="flex flex-col min-h-0">
		<div class="flex items-center justify-between mb-2 flex-shrink-0">
			<label class="text-xs font-semibold text-slate-500">JS 源代码输入</label>
		...
		<div class="relative flex-1 min-h-0 json-pane">
			<n-input
				...
				placeholder="粘贴 JavaScript 代码，例如: function add(a, b) { return a + b; }"
				type="textarea"
			...
			>
				...
				<p class="text-slate-400 text-xs">粘贴 JS 代码后点击混淆</p>
			</div>
		</div>
	</div>
</template>
