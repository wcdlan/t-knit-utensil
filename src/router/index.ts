	...
	routes: [
		{ path: '/', component: Home },
		{
			...
			children: [
				...
				{ path: 'file-size', component: () => import('@/view/tool/converter/FileSizeView.vue') },
				{ path: 'chmod', component: () => import('@/view/tool/converter/ChmodView.vue') },
				...
				{ path: 'raid-calc', component: () => import('@/view/tool/common/RaidCalcView.vue') },
